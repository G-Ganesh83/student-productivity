    ...
    <div className="min-h-screen bg-surface-1 flex">
      ...
      <aside className="hidden lg:flex fixed inset-y-0 left-0 w-[240px] flex-col bg-[#fdfdfd] border-r border-slate-200/60 z-30">
        ...
        <div className="px-3 py-4 space-y-1 mt-auto flex-shrink-0">
          <button className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-100/80 transition-all group">
            <span className="text-slate-400 group-hover:text-slate-600 transition-transform group-hover:scale-110">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 h-16 border-b border-slate-100">
              ...
              >
                ...
                <span className="text-base font-bold text-slate-800 tracking-tight">StudyHub</span>
              </Link>
              <button
                onClick={() => setIsMobileOpen(false)}
            ...
            <div className="px-3 py-4 space-y-1 border-t border-slate-100">
              <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-600 hover:text-slate-900 hover:bg-slate-100/80 transition-all">
